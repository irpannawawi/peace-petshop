...
<table class="table table-bordered table-striped" id="dataTable" width="100%" cellspacing="0">
 ...
 <td>{{ $ctm->alamat}}</td>
 <td>{{ $ctm->no_telp}}</td>
 <td align="center"><a href="{{route('customer.edit',[$ctm->kd_ctm])}}"class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm">
 <i class="fas fa-edit fa-sm text-white-50"></i> Edit</a>
 <a href="/customer/hapus/{{$ctm->kd_ctm}}" onclick="return confirm('Yakin Ingin menghapus data?')" class="d-none d-sm-inline-block btn btn-sm btn-danger shadow-sm">
...
<div class="modal fade" id="exampleModalScrollable" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
 ...
 <input type="text" name="addkdctm" id="addkdctm" class="form-control" maxlegth="10" id="exampleFormControlInput1" >
 </div>
 <div class="form-group">
 <label for="exampleFormControlInput1">Nama</label>
 <input type="text" name="addnmctm" id="addnmctm" class="form-control" id="exampleFormControlInput1" >
 </div>
