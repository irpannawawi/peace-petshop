...
@section('content')
        ...
        <div id="header-carousel" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100" src="/pet-care/img/carousel-1.jpg" alt="Image">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            ...
                            <a href="" class="btn btn-lg btn-primary mt-3 mt-md-4 px-4">Masuk</a>
                            <a href="" class="btn btn-lg btn-secondary mt-3 mt-md-4 px-4">Daftar</a>
                        </div>
                    </div>
                </div>
                <div class="carousel-item">
                    <img class="w-100" src="/pet-care/img/carousel-2.jpg" alt="Image">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h3 class="text-white mb-3 d-none d-sm-block">Best Pet Services</h3>
                            <h1 class="display-3 text-white mb-3">Pet Foods & Grooming</h1>
                            <a href="" class="btn btn-lg btn-primary mt-3 mt-md-4 px-4">Masuk</a>
                            <a href="" class="btn btn-lg btn-secondary mt-3 mt-md-4 px-4">Daftar</a>
                        </div>
                    </div>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-5">
                <img class="img-fluid w-100" src="/pet-care/img/feature.jpg" alt="">
            </div>
            <div class="col-lg-7 py-5 py-lg-0 px-3 px-lg-5">
