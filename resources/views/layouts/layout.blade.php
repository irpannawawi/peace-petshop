        ...
        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
                <div class="sidebar-brand-icon rotate-n-0">
                    <img src="{{asset('asset/img/petshop.png')}}" width="30">
                </div>
                <div class="sidebar-brand-text mx-2">Peace Petshop & Grooming</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages1" class="collapse" aria-labelledby="headingPages"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item fas fa-arrow-circle-right" href="/a/transaksi">Transaksi</a>
                        <a class="collapse-item fas fa-arrow-circle-right" href="/a/jadwal">Jadwal</a>
                    </div>
                </div>
            </li>
            @endif
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <form
                        ...
                        <div class="input-group">
                            <div class="input-group-append">
                                <h4>Data Office Peace Petshop Karawang</h4>
                            </div>
                        </div>
                    </form>
                    @endif
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Create By: Risfah Rahmalia<br>Copyright &copy; Peace Petshop & Grooming</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
